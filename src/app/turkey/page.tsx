    ...
    <p className="text-sm md:text-base text-[#EFE7DA]/80 max-w-2xl mx-auto leading-relaxed">
      ...
      <div className="mb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          <Link href="/turkey/student-services" className="block transition-transform hover:-translate-y-1">
            <ServiceCard
              icon={GraduationCap}
              title="Student Services"
              desc="Practical support for starting your new life in Turkey: SIM guidance, housing assistance, and local orientation."
            />
          </Link>

          <Link href="/turkey/translation" className="block transition-transform hover:-translate-y-1">
            <ServiceCard
              icon={Languages}
              title="Translation Services"
              desc="Language assistance when everyday communication gets difficult: quick calls, messages, and in-person interpretation."
            />
          </Link>

          <Link href="/turkey/travel" className="block transition-transform hover:-translate-y-1">
            <ServiceCard
              icon={Compass}
              title="Travel Services"
              desc="Personalized travel planning and local support in Turkey: custom itineraries and friendly local accompaniment."
            />
          </Link>

          <Link href="/turkey/paperwork" className="block transition-transform hover:-translate-y-1">
            <ServiceCard
              icon={FileCheck}
              title="Paperwork & Administrative Assistance"
              desc="Practical help with documents, appointments, residence permits, tax numbers, translation, and everyday administrative tasks in Turkey."
            />
          </Link>
        </div>
      </div>
