      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {currentCities.map((city) => (
          <Link
            key={city.name}
            href={city.href}
            className="group relative h-[380px] rounded-[24px] overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-brand-plum/10 cursor-pointer block"
          >
            ...
            <div className="absolute inset-0 p-6 flex flex-col justify-between z-10">
              ...
              <div>
                ...
                <div className="inline-flex items-center space-x-2 text-xs uppercase tracking-wider font-semibold text-brand-gold bg-brand-ivory/10 hover:bg-brand-ivory/20 backdrop-blur-md px-4 py-2 rounded-full transition-all border border-brand-gold/30">
